...
import { PhaseCountdown } from "src/countdown";
...
import {
  ...
  purchaseTicket,
  receiveRefund,
} from "src/fair-launch";

import { formatNumber, getAtaForMint, toDate } from "src/utils/utils";
...
function getPhase(
  ...
  if (phaseOneEnd && curr <= phaseOneEnd) {
    return Phase.Phase1;
  }
  if (phaseTwoEnd && curr <= phaseTwoEnd) {
    return Phase.Phase2;
  }
  if (!fairLaunch?.state.phaseThreeStarted) {
            ...
            >
              ...
              <MuiDialogContent>
                ...
                <Typography gutterBottom color="textSecondary">
                  ...
                  all bids will be the &quot;fair&quot; price of the raffle
                  ticket.{" "}
                  {fairLaunch?.state?.data?.fee && (
                    <span>
                      <b>
                ...
                <Typography gutterBottom color="textSecondary">
                  ...
                  get a raffle ticket at that price. There&apos;s nothing else
                  you need to do. Your excess SOL will be returned to you when
                  the Fair Launch authority withdraws from the treasury. If your
                  bid is below the median price, you can still opt in at the
                  fair price during this phase.
                </Typography>
